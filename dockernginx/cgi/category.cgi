...
<body>
	...
	<section class="songs-section">
		<div class="container">            result.append(line)
			<!-- song  -->
			""")
songs = ["Une souris verte", "Au clair de la lune", "Metalocalypse: Death to all"]
for song_title in songs:
	random_image = random.randint(1,9)
	print(f"""
			<div class="song-item">
				<div class="row">
					<div class="col-lg-4">
						<div class="song-info-box">
							<img src="img/songs/{random_image}.jpg" alt="">
							<div class="song-info">
